...
public class ResultResponse {
	...
	public static final ResultResponse FAILED = new ResultResponse(STATUS_UNKNOWN_FAILED,
			MessageResponse.UNKNOWN_FAILED);
	public static final ResultResponse BAD_REQUEST = new ResultResponse(STATUS_BAD_REQUEST,
			MessageResponse.BAD_REQUEST);
	public static final ResultResponse UNAUTHORIZED = new ResultResponse(STATUS_UNAUTHORIZED,
	...
	public static final ResultResponse TOO_MANY_REQUEST = new ResultResponse(STATUS_TOO_MANY_REQUEST,
			MessageResponse.TOO_MANY_REQUEST);
	...
	public ResultResponse withMessage(String message) {
		return new ResultResponse(this.status, message, null);
	}
